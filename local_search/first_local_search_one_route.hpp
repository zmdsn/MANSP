 ...
 * 
 ************************************************************************/
#ifndef  _ONE_ROUTE_FIRST_LocalSearch__HPP__
#define  _ONE_ROUTE_FIRST_LocalSearch__HPP__
#include <sstream>
#include <iostream>
#include <string>
#include <ostream>
...
using namespace std;
template<class M>
class FLSS:public LocalSearchBase{
  public:
    M* wanted_move;
    M* temp_move;
    ...
    FLSS(CARP_INDIVIDUAL* indi):LocalSearchBase(indi){
      wanted_move = new M(indi);
      temp_move   = new M(indi);  
    };
    FLSS(CARP_INDIVIDUAL* indi, M* _wanted_move,
