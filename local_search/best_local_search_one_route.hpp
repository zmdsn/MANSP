 ...
 * 
 ************************************************************************/
#ifndef  _ONE_ROUTE__BLSS__HPP__
#define  _ONE_ROUTE__BLSS__HPP__
#include <sstream>
#include <iostream>
#include <string>
#include <ostream>
...
using namespace std;
template<class M>
class BLSS:public LocalSearchBase{
  public:
    M* wanted_move;
    M* temp_move;
    ...
    BLSS(CARP_INDIVIDUAL* indi):LocalSearchBase(indi){
      wanted_move = new M(indi);
      temp_move   = new M(indi);  
    };
    BLSS(CARP_INDIVIDUAL* indi,    M* _wanted_move,
