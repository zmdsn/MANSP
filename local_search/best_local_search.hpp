 ...
 * 
 ************************************************************************/
#ifndef  __BestLocalSearch__HPP__
#define  __BestLocalSearch__HPP__
#include <sstream>
#include <iostream>
#include <string>
#include <ostream>
...
template<class M>
class BestLocalSearch:public LocalSearchBase{
  public:
    M* wanted_move;
    M* temp_move;
    ...
    BestLocalSearch(CARP_INDIVIDUAL* indi):LocalSearchBase(indi){
        wanted_move = new M(indi);
        temp_move   = new M(indi);  
    };
    BestLocalSearch(CARP_INDIVIDUAL* indi,    M* _wanted_move,
