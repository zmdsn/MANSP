 ...
 * 
 ************************************************************************/
#ifndef  __PaticalBestFeasibleLocalSearch__HPP__
#define  __PaticalBestFeasibleLocalSearch__HPP__
#include <sstream>
#include <iostream>
#include <string>
#include <ostream>
...
template<class M>
class PaticalBestFeasibleLocalSearch:public LocalSearchBase{
  public:
    M* wanted_move;
    M* temp_move;
    ...
    PaticalBestFeasibleLocalSearch(CARP_INDIVIDUAL* indi):
      LocalSearchBase(indi) {
        wanted_move = new M(indi);
        temp_move   = new M(indi);  
    };
    PaticalBestFeasibleLocalSearch(CARP_INDIVIDUAL* indi, M* _wanted_move, M* _move):
      LocalSearchBase(indi,_wanted_move,_move){
    }
    ~PaticalBestFeasibleLocalSearch(){};
};
#endif
