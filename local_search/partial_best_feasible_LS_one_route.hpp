 ...
 * 
 ************************************************************************/
#ifndef  _ONE_ROUTE_P_BEST_FLS__HPP__
#define  _ONE_ROUTE_P_BEST_FLS__HPP__
#include <sstream>
#include <iostream>
#include <string>
#include <ostream>
...
// 
template<class M>
class PBFLSS:public LocalSearchBase{
  public:
    M* wanted_move;
    M* temp_move;
    ...
    PBFLSS(CARP_INDIVIDUAL* indi):LocalSearchBase(indi){
        wanted_move = new M(indi);
        temp_move   = new M(indi);  
    };
    PBFLSS(CARP_INDIVIDUAL* indi, M* _wanted_move, M* _move):
