 ...
 * 
 ************************************************************************/
#ifndef  _ONE_ROUTE__FIRST_FEASIBLE_LocalSearch__HPP__
#define  _ONE_ROUTE__FIRST_FEASIBLE_LocalSearch__HPP__
#include <sstream>
#include <iostream>
#include <string>
#include <ostream>
...
template<class M>
class FFLSS:public LocalSearchBase{
  public:
    M* wanted_move;
    M* temp_move;
    ...
    FFLSS(CARP_INDIVIDUAL* indi):LocalSearchBase(indi){
      wanted_move = new M(indi);
      temp_move   = new M(indi);  
    };
    FFLSS(CARP_INDIVIDUAL* indi, M* _wanted_move,
